...
def contact(request):
    if request.method == "POST":
        en=Contact(contactname=request.POST.get('name'),contactemail=request.POST.get('email'),
...
def tieup(request):
    if request.method == "POST":
        ...
        en=Tieup(name=request.POST.get('name').title(),email=request.POST.get('email'),message = request.POST.get('message'), mobile = request.POST.get('mobile'), 
            profile = request.POST.get('profile'), instagram_id = request.POST.get('instagram'),country=request.POST.get('country'))
